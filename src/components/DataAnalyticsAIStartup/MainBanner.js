            ...
            <div className="col-lg-5 col-md-12">
              <div className="banner-content">
                <ReactWOW delay=".1s" animation="fadeInLeft">
                  <h1>The Gateway to Africa’s Social Circles</h1>
                </ReactWOW>

                <ReactWOW delay=".1s" animation="fadeInLeft">
                  <p>
                    We facilitate frictionless interactions and value exchange
                    across social circles to create wealth and opportunities for
                    Africans
                  </p>
                </ReactWOW>
